...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Corrupted', 0.2], //From 0% to 19%
		['Losing', 0.4], //From 20% to 39%
		['Controlled, 0.5], //From 40% to 49%
		['Mindless', 0.6], //From 50% to 59%
		['Soul', 0.69], //From 60% to 68%
		['Saving', 0.7], //69%
		['Winning', 0.8], //From 70% to 79%
		['Control', 0.9], //From 80% to 89%
		['Escaping', 1], //From 90% to 99%
		['Escaped', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
